package com.bdqn.syht.pojo.delivery;
...
import com.bdqn.syht.utils.Constants;
...
public class Promotion implements Serializable {
	...
	public String getTitleImg() {
		if (titleImg.startsWith("http://localhost:9001")) {
			return titleImg;
		}
		return "http://localhost:9001" + titleImg;
	}
	...
	public String getDescription() {
		if (description.contains("<img src=\"" + "http://localhost:9001" + "/")) {
			return description;
		}
		return description.replace("<img src=\"/", "<img src=\"" + "http://localhost:9001" + "/");
	}
